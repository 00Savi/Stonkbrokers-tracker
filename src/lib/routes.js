...
export function tabsForProject(meta) {
  ...
  if (meta?.key === 'interns') {
    return tabs.filter((t) => t.slug !== 'liquidity' && t.slug !== 'burn');
  }
...
export const PROJECTS = [
  ...
  { slug: 'coattail', key: 'coattail', name: 'Coattail Brokers', ticker: 'COAT', kind: 'brokers', logo: 'Coattail.svg', beta: true, unitValue: 36750, live: false },
