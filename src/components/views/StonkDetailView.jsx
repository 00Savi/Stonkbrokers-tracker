                            ...
                            <div className="relative h-32 md:h-40 w-full">
                              <Line 
                                data={{ 
                                  ...
                                  datasets: [{ label: 'Daily Yield (USD)', data: t.dailyYields?.length ? t.dailyYields : [20, 15, 30, 25, 35, 20, 30], borderColor: '#3b82f6', backgroundColor: 'rgba(59, 130, 246, 0.1)', borderWidth: 2, fill: true, tension: 0.4, pointRadius: 3 }] 
                                }} 
            ...
            <div className="relative h-72 md:h-80 w-full">
              <Bar 
                data={{
                  labels: revDates,
                  datasets: [
                    { label: "AMM & Swaps", data: revData1, backgroundColor: "#34d399", borderRadius: 4 },
                    { label: "Clock-In Box", data: revData2, backgroundColor: "#60a5fa", borderRadius: 4 },
                    { label: "Safe Launchpad", data: revData3, backgroundColor: "#a78bfa", borderRadius: 4 }
                  ]
                }} 
             ...
             <div className="relative h-72 md:h-80 w-full">
                <Bar 
                  data={{
                    labels: actLabels,
                    datasets: [
                      { type: 'line', label: 'Net Active Units', data: actCum, borderColor: '#3b82f6', backgroundColor: 'rgba(59, 130, 246, 0.05)', borderWidth: 3, fill: true, tension: 0.3, yAxisID: 'y' },
      ...
      {activeTab === 'ownership' && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-[#0f172a] border border-[#334155] rounded-xl p-5 shadow-inner"><p className="text-[10px] md:text-xs uppercase tracking-wider text-slate-400 mb-1">Permanently Burnt</p><p className="text-xl md:text-3xl font-extrabold text-orange-400">{formatNumber(burntNfts, 2)}</p></div>
            <div className="bg-[#0f172a] border border-[#334155] rounded-xl p-5 shadow-inner"><p className="text-[10px] md:text-xs uppercase tracking-wider text-slate-400 mb-1">AMM Vault Inventory</p><p className="text-xl md:text-3xl font-extrabold text-slate-300">{formatNumber(ownership.ammVaultNfts || 2192)}</p></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-[#1e293b] border border-[#334155] rounded-xl p-5 shadow-sm"><p className="text-xs uppercase tracking-wider text-slate-400 mb-1">Unique $STONK Holders</p><p className="text-2xl md:text-3xl font-extrabold text-purple-400">{formatNumber(stonkHolders)} Wallets</p></div>
          </div>
