                            ...
                            <div className="relative h-32 md:h-40 w-full">
                              <Line 
                                data={{ 
                                  ...
                                  datasets: [{ label: 'Daily Yield (USD)', data: t.dailyYields?.length ? t.dailyYields : [12, 10, 18, 14, 20, 12, 18], borderColor: '#38bdf8', backgroundColor: 'rgba(56, 189, 248, 0.1)', borderWidth: 2, fill: true, tension: 0.4, pointRadius: 3 }] 
                                }} 
            ...
            <div className="relative h-72 md:h-80 w-full">
              <Bar 
                data={{
                  labels: revDates,
                  datasets: [
                    { label: "Vault Distributions", data: revData1, backgroundColor: "#00a804", borderRadius: 4 },
                    { label: "Yard AMM Fees", data: revData2, backgroundColor: "#38bdf8", borderRadius: 4 },
                    { label: "Ecosystem Fees", data: revData3, backgroundColor: "#8b5cf6", borderRadius: 4 }
                  ]
                }} 
             ...
             <div className="relative h-72 md:h-80 w-full">
                <Bar 
                  data={{
                    labels: actLabels,
                    datasets: [
                      { type: 'line', label: 'Net Active Units', data: actCum, borderColor: '#38bdf8', backgroundColor: 'rgba(56, 189, 248, 0.05)', borderWidth: 3, fill: true, tension: 0.3, yAxisID: 'y' },
      ...
      {activeTab === 'ownership' && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-[#0e1013] border border-[#1e2228] rounded-xl p-5 shadow-sm"><p className="text-xs uppercase tracking-wider text-slate-400 mb-1">Unique ${config.ticker} Holders</p><p className="text-2xl md:text-3xl font-extrabold text-purple-400">{formatNumber(yardHolders)} Wallets</p></div>
          </div>
